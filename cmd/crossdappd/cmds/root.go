...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	encodingConfig := crossdapp.MakeEncodingConfig()
	initClientCtx := client.Context{}.
		...
		WithHomeDir(crossdapp.DefaultNodeHome).
		WithViper("")

	rootCmd := &cobra.Command{
		Use:   crossdapp.Name + "d",
		Short: "Cosmos Cross ChainApp",
	...
	initRootCmd(
		rootCmd,
		encodingConfig,
		crossdapp.ModuleBasics,
		crossdapp.DefaultNodeHome,
	)
	overwriteFlagDefaults(rootCmd, map[string]string{
		flags.FlagChainID:        crossdapp.Name,
...
func appExport(
	...
	encCfg := crossdapp.MakeEncodingConfig() // Ideally, we would reuse the one created by NewRootCmd.
	...
	exportableApp := crossdapp.NewApp(
		logger,
		db,
		traceStore,
